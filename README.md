...
Mouse Library
Working Principle
The MPU6050 sensor reads acceleration and gyroscope values.
Arduino processes the motion data.
Accelerometer values are mapped to mouse cursor movement.
Cursor moves based on hand tilt or finger movement.
Two switches are used for left-click and right-click operations.
Code Description
